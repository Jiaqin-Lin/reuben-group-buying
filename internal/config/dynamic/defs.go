...
// FeatureUseMockPayment 支付网关切换：true=Mock（自动成功），false=真实支付宝。
// 开发/测试时开启 Mock，免去真实支付对接。
var FeatureUseMockPayment = NewDef("feature.use_mock_payment", true, "Mock支付：true=Mock自动成功 false=真实支付宝")
